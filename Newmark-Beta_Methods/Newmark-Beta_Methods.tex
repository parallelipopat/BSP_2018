...
\centering
 	\begin{tabular}{@{}cc@{}}
		\includegraphics[width=0.5\textwidth, height=0.3\textheight]{convergence_beta_0,00.eps} &
    		\includegraphics[width=0.5\textwidth, height=0.3\textheight]{convergence_beta_0,25.eps} \\
    		\includegraphics[width=0.5\textwidth, height=0.3\textheight]{convergence_beta_0,50.eps} &
   		\includegraphics[width=0.5\textwidth, height=0.3\textheight]{convergence_beta_0,75.eps} \\
    		\multicolumn{2}{c}{\includegraphics[width=.5\textwidth, height=0.3\textheight]{convergence_beta_1,00.eps}}
  	\end{tabular}
